...
class EHPdecompose(nn.Module):
    def __init__(self, conv_layer, rank=1, init=True, alpha=1.0, bn=False, relu=False, groups=1):
        ...
        super(EHPdecompose, self).__init__()
        self.rank = rank
        self.alpha = alpha
        self.bn_ = bn
        self.relu_ = relu
    ...
    def decompose(self, conv, pw, dw, lr=0.01, steps=10000):
        """
        EHP decompose standard convolution kernel
    ...
    def decompose_rank(self, kernel, lr=5e-3, steps=10000):
        """
        EHP decompose standard convolution kernel with different rank
        :param conv: standard convolution kernel
        :param lr: learning rate
        :param steps: training steps for decomposing
        """
